...
export function normalizeInlineText(rawText) {
  return rawText
    .replace(/\u00a0/g, " ")
    .replace(/\s+/g, " ")
    .trim();
...
export function isHiddenFromRendering(element) {
...
export function extractQuestionTextFromDocument(documentNode) {
...
export function splitText(text, maxChunkLength = 1500) {

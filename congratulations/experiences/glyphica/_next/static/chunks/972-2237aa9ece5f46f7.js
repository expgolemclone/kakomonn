      ...
      let y = a.default.forwardRef(function (e, t) {
        ...
        let G = C ? r && "object" == typeof r && r.ref : t,
          ...
          K = a.default.useCallback(
            (e) => {
              ((W.current !== F || X.current !== k) && (B(), (W.current = F), (X.current = k)),
                H(e),
        ...
        a.default.useEffect(() => {
          w && Y && D && E(w, k, F, { locale: v }, { kind: U }, L);
        }, [F, k, Y, v, D, null == j ? void 0 : j.locale, w, L, U]);
        let V = {
          ref: K,
          onClick(e) {
          ...
          onMouseEnter(e) {
            (C || "function" != typeof N || N(e),
              ...
              w &&
                (D || !L) &&
                E(w, k, F, { locale: v, priority: !0, bypassPrefetchedCheck: !0 }, { kind: U }, L));
          },
        ...
        if ((0, l.isAbsoluteUrl)(F)) V.href = F;

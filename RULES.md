...
- `congratulations`を変更した場合は,push後にPlaywrightで`https://kakomonn-congratulations.vercel.app/?milestone=50`を開き,期待する主要要素が表示され,page errorが発生していないことを確認すること. 正常表示を確認できない場合は,作業を完了せず,原因を修正すること.

...
!(function (e, t) {
  ...
  function Cb(e, t) {
    if (ct(e)) {
      ...
      (~r && (e.indexOf("%") > r && (n *= t / 100), (e = e.substr(0, r - 1))),
        (e =
          n +
          (e in H ? H[e] * t : ~e.indexOf("%") ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)));
    }
    return e;
  }
    ...
    if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), i)) {
      ...
      ((g = "scroll" + n.d2),
        X(
          ...
          C,
          n,
          (T && 20 < C) || (!T && (u ? Math.max(We[g], Je[g]) : i.parentNode[g]) <= C + 1),
        ),
  ...
  function pc(r, e, n) {
    ...
    return function (e) {
      var t = Math.round(r());
      return (
        t !== o && t !== i && 3 < Math.abs(t - o) && 3 < Math.abs(t - i) && ((e = t), n && n()),
        (i = o),
        (o = e)
      );
    };
  ...
  var He,
    ...
    ne =
        ...
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
          ...
          if (
            ...
            ue &&
              ...
              Ie.forEach(function (e) {
                return (
                  Ta(e) && e.target === (me ? Xe.scrollingElement || Je : be) && (e.smooth = !1)
                );
              }),
              (p = Ta(ue.snapTo)
                ? ue.snapTo
                        ...
                        o,
                        {
                          ...
                          onComplete: function onComplete() {
                            (Te.update(),
                              ...
                              O &&
                                (ee
                                  ? ee.resetTo("totalProgress", n, O._tTime / O._tDur)
                                  : O.progress(n)),
            ...
            (i =
              (i =
                (ie = Te.trigger = J(ie || (!0 !== ae && ae))) && ie._gsap && ie._gsap.stRevert) &&
              i(Te)),
            (ae = !0 === ae ? ie : J(ae)),
          ...
          if (
              ...
              if ((!je && Te.enabled) || t)
                if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                  ...
                  if (
                    ...
                    Te._endClamp &&
                      !rt &&
                      ((Te._endClamp = q || -0.001), (q = Math.min(q, Qa(be, he)))),
                    (N = q - B || ((B -= 0.01) && 0.001)),
                  ...
                  (p &&
                    ...
                    (x || Oe !== Te.progress || de || le) &&
                      (O &&
                        !ve &&
                        O.totalProgress(
                          de && B < -0.001 && !Oe ? He.utils.normalize(B, q, 0) : Oe,
                          !0,
                        ),
            ...
            (Te.labelToScroll = function (e) {
              return (
                (O && O.labels && (B || Te.refresh() || B) + (O.labels[e] / O.duration()) * N) || 0
              );
            }),
                    ...
                    a && !je
                      ? (ve &&
                        ...
                        pe &&
                          ...
                          (Wa(Te.callbackAnimation),
                          ee ? ee.progress(1) : Wa(O, "reverse" === i ? 1 : !d, 1)))
                      : ve && T && !je && T(Te));
                }
                if (x) {
            ...
            (Te.setPositions = function (e, t, r, n) {
              ...
              (Te.refresh(
                !1,
                !1,
                { start: Da(e, r && !!Te._startClamp), end: Da(t, r && !!Te._endClamp) },
                n,
              ),
                Te.update());
            }),
      ...
      (ScrollTrigger.register = function register(e) {
        return (
          s || ((He = e || Ka()), Ja() && window.document && ScrollTrigger.enable(), (s = lt)), s
        );
      }),
  ...
  function Bc(e) {
    ...
    var n,
      ...
      h = g && g.get(),
      v =
        E && ((e.content && J(e.content)) || (h && !1 !== e.content && !h.smooth() && h.content())),
      b = K(p, Fe),
      m = K(p, Ye),
      y = 1,
      x =
    ...
    return (
      ...
      (e.onChange = function (e, t, r, n, o) {
        if (
          (kt !== l && Cq(), t && f && m(T(n[2] === t ? c + (e.startX - e.x) : m() + t - n[1])), r)
        ) {
          b.offset && Dq();
          var i = o[2] === r,

...
(() => {
  ...
  if (form) {
    ...
    form.addEventListener('submit', (e) => {
      ...
      status.textContent = 'Moment marked. dailyKpiCompleted is true: all due cards are complete and the daily new-question goal is reached, and this finish is yours.';
